        ...
        <footer style={{ position: "relative", overflow: "hidden" }}>
            ...
            <div
                ...
                style={{
                    ...
                    background: "var(--navy)",
                    clipPath:
                        "polygon(0% 100%, 2% 20%, 4% 80%, 6% 15%, 8% 75%, 10% 25%, 12% 85%, 14% 10%, 16% 70%, 18% 30%, 20% 80%, 22% 15%, 24% 75%, 26% 25%, 28% 85%, 30% 10%, 32% 70%, 34% 20%, 36% 80%, 38% 15%, 40% 75%, 42% 25%, 44% 85%, 46% 10%, 48% 70%, 50% 20%, 52% 80%, 54% 15%, 56% 75%, 58% 25%, 60% 85%, 62% 10%, 64% 70%, 66% 30%, 68% 80%, 70% 15%, 72% 75%, 74% 25%, 76% 85%, 78% 10%, 80% 70%, 82% 20%, 84% 80%, 86% 15%, 88% 75%, 90% 25%, 92% 85%, 94% 10%, 96% 70%, 98% 20%, 100% 100%)",
                }}
            />
